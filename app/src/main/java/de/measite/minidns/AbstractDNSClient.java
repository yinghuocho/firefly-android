...
public abstract class AbstractDNSClient {
     ...
     */
    protected AbstractDNSClient(DNSCache cache, VpnService vpn) {
        Random random;
        try {
        ...
        this.random = random;
        this.cache = cache;
        this.dataSource = new NetworkDataSource(vpn);
    }

    /**
     * Create a new DNS client using the global default cache.
     */
    protected AbstractDNSClient(VpnService vpn) {
        this(DEFAULT_CACHE, vpn);
    }
